...
The only issue that came up were the input fields on the contact page, which don't have a label since their description is already visible in the input field.
